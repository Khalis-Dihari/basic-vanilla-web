...
1.  After I create branch css-basic I can push directly to main. <br>
...
2.  Some commit rule from <link>https://www.conventionalcommits.org</link><br>
before this I am using "fix(README.md): bla.. bla.." for changing inside of the content of the readme and or even fix(CSS). The format should be chore(README.md). Example of using commit format
```bash
